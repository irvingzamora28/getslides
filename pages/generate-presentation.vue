<template>
  <div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mb-8">
      ...
      <!-- Regular button to generate presentation -->
      <button
        @click.prevent="generatePresentation"
        :disabled="!prompt || store.loading"
        class="px-4 py-2 text-white bg-indigo-600 rounded shadow hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 dark:focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
      >
...
async function generatePresentation() {
  console.log('Generate Presentation clicked'); // Debugging log
